...
class LoadScene extends Phaser.Scene {
    ...
    preload() { // Loading All Assets That Are Used
        ...
        this.load.image('hudTank', 'assets/sprites/USED_HUD_FERRUM.png');
        this.load.spritesheet('QTankskill', 'assets/sprites/QTankskill.png', { frameWidth: 32, frameHeight: 32 });
        this.load.spritesheet('WTankskill', 'assets/sprites/WTankskill.png', { frameWidth: 32, frameHeight: 32 });
        this.load.spritesheet('ETankskill', 'assets/sprites/ETankskill.png', { frameWidth: 32, frameHeight: 32 });
        this.load.spritesheet('RTankskill', 'assets/sprites/RTankskill.png', { frameWidth: 32, frameHeight: 32 });
        ...
        this.load.spritesheet('WTbullet', 'assets/sprites/slowingBulletSpriteSheet.png', { frameWidth: 50, frameHeight: 50 });
        this.load.spritesheet('WTdeadAnims', 'assets/sprites/slowingBulletDeath.png', { frameWidth: 50, frameHeight: 50 });
        ...
        this.load.spritesheet('RTbullet', 'assets/sprites/bigBullet.png', { frameWidth: 32, frameHeight: 32 });
        this.load.spritesheet('RTdeadAnims', 'assets/sprites/bulletDeath.png', { frameWidth: 32, frameHeight: 32 });
